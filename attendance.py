...
class Attendance:
    def __init__(self, root):
        ...
        # Font in image
        title_lbl = Label(lbl_1, text="Attendance Details", font=("Arial", 42, "bold"), bg="gold", fg="green")
        ...
        # Left frame
        Left_frame = LabelFrame(main_frame, bd=2, bg="white", relief=RIDGE, text="Attendance Info", font=("arial", 15, "bold"))
        ...
        # for id
        id_label = Label(Left_table_frame, text="Attendance Id", font=("arial", 12, "bold"), bg="white")
        id_label.grid(row=0, column=0, padx=10,pady=10, sticky=W)

        id_entry=ttk.Entry(Left_table_frame,textvariable=self.var_atten_id,width=20,font=("arial", 12, "bold"))
        id_entry.grid(row=0, column=1, padx=10, pady=10 ,sticky=W)
        #for name
        name_label = Label(Left_table_frame, text="Name", font=("arial", 12, "bold"), bg="white")
        name_label.grid(row=0, column=2, padx=10,pady=10, sticky=W)

        name_entry=ttk.Entry(Left_table_frame, textvariable=self.var_atten_name,width=20,font=("arial", 12, "bold"))
        name_entry.grid(row=0, column=3, padx=10, pady=10, sticky=W)

        #for roll no
        roll_label = Label(Left_table_frame, text="Roll no", font=("arial", 12, "bold"), bg="white")
        roll_label.grid(row=1, column=0, padx=10, pady=10, sticky=W)

        roll_entry=ttk.Entry(Left_table_frame,textvariable=self.var_atten_roll,width=20,font=("arial", 12, "bold"))
        roll_entry.grid(row=1, column=1, padx=10, pady=10, sticky=W)

        depart_label = Label(Left_table_frame, text="Department", font=("arial", 12, "bold"), bg="white")
        depart_label.grid(row=1, column=2, padx=10,pady=10, sticky=W)

        depart_entry=ttk.Entry(Left_table_frame,textvariable=self.var_atten_dep,width=20,font=("arial", 12, "bold"))
        ...
        time_label = Label(Left_table_frame, text="Time", font=("arial", 12, "bold"), bg="white")
        time_label.grid(row=2, column=0, padx=10,pady=10, sticky=W)

        time_entry=ttk.Entry(Left_table_frame, textvariable=self.var_atten_time,width=20,font=("arial", 12, "bold"))
        time_entry.grid(row=2, column=1, padx=10, pady=10 ,sticky=W)

        date_label = Label(Left_table_frame, text="Date", font=("arial", 12, "bold"), bg="white")
        date_label.grid(row=2, column=2, padx=10,pady=10, sticky=W)

        date_entry=ttk.Entry(Left_table_frame,textvariable=self.var_atten_date,width=20,font=("arial", 12, "bold"))
        date_entry.grid(row=2, column=3, padx=10, pady=10 ,sticky=W)

        # attendance
        attendanceLabel=Label(Left_table_frame, text="Attendance Status", bg="white", font=("arial", 12, "bold")) 
        attendanceLabel.grid(row=3, column=0, padx = 10)
        self.atten_status=ttk.Combobox(Left_table_frame,textvariable=self.var_atten_attendance,width=20, font="comicsansns 11 bold", state="readonly")
        ...
        #    Import csv
        save= Button(btn_frame,text="Import csv", command = self.importCsv,width=15,font=("arial",12,"bold"),bg="green",fg="white",)
        save.grid(row=0,column=0,padx=2)
        # Export csv
        update= Button(btn_frame,text="Export csv",command = self.exportCsv,width=15,font=("arial",12,"bold"),bg="blue",fg="white")
        update.grid(row=0,column=1,padx=2)
        
        #update csv
        delete= Button(btn_frame,text="Update",width=15,font=("arial",12,"bold"),bg="red",fg="white")
        delete.grid(row=0,column=2,padx=2)
        
        reset= Button(btn_frame,text="Reset",width=15,command = self.reset_data,font=("arial",12,"bold"),bg="red",fg="white")
